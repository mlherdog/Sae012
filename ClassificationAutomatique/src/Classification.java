...
public class Classification {
    ...
    public static void classementDepeches(ArrayList<Depeche> depeches, ArrayList<Categorie> categories, String nomFichier) {
        ...
        try {
            ...
            file.write("\nMOYENNE:"+((compteur_reussi)/vCat_Reusite.size()+"%\n"));
            file.close();
...
//        n'est pas dans la catégorie categorie et incrémenté si la dépêche est dans la catégorie categorie.
    ...
    public static void generationLexique(ArrayList<Depeche> depeches, String categorie) {
...
//        résultant pour créer un fichier lexique en utilisant la fonction poidsPourScore.
        try{
            ...
            ArrayList<PaireChaineEntier> dictionaire = initDico(depeches,categorie); // construction du vecteur avec les mots contrnu dans les depeches

            calculScores(depeches,categorie,dictionaire);// affectation d'un score pour chaque mots
...
*/
       // Creation de 5 catégories puis Creation d'une Arraylist de categorie
        ...
        generationLexique(depeches,"SPORTS");
        generationLexique(depeches,"CULTURE");
        generationLexique(depeches,"POLITIQUE");
        generationLexique(depeches,"ECONOMIE");
...
*/
       ...
       classementDepeches(depeches,lesCategories,"fichier_resultat.txt");
    }
}
